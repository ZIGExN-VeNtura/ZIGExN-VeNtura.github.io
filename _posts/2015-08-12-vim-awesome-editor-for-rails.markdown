...
// Image Cheatsheet: http://www.viemu.com/vi-vim-cheat-sheet.gif
  ...
  - Để tìm kiếm từ trong toàn project hoặc 1 thư mục: Sử dụng plugin https://github.com/rking/ag.vim (phần 2)
...
__2. VIM plugins__
  ...
  - NERDTree: Cây thư mục cho VIM (https://github.com/scrooloose/nerdtree)
  - Ctrlp: Tìm kiếm tên file theo phong cách Ctrl + p (https://github.com/kien/ctrlp.vim)
  - Vim-rails: VIM theo phong cách rails (https://github.com/tpope/vim-rails)
  - Vim-fugitive: Tích hợp các lệnh của Git trong VIM (https://github.com/tpope/vim-fugitive)
  - Ag.vim: Giúp tìm kiếm từ trong thư mục hoặc cả project (https://github.com/rking/ag.vim)
...
- http://vimawesome.com/
- https://github.com/lannn/dotfiles/blob/master/vimrc.local
...
__3. VIM với Tmux__
  ...
  Có 1 gem giúp config các window và panes theo 1 định nghĩa quy ước trước gọi là tmuxinator (https://github.com/tmuxinator/tmuxinator). Dưới đây là ví dụ config 1 project:
